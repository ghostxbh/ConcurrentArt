package com.uzykj.mall.comment.algorithm;

import java.util.Arrays;

/**
 * Create by xbh 2019-05-15 二分查找实现蛋糕切分
 * 转载至：程序员小灰
 * 原文地址：https://mp.weixin.qq.com/s/reTcC_XO2ArDattFqeQ0oA
 */
public class BinarySearch {
    ...
    public static void main(String[] args) {
        int[] cakes = new int[]{5,8,26,32,12,6};

        int[] mouths = new int[]{3,30,25,10,8,6,4,7};
